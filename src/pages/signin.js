    ...
    <div class="flex flex-col justify-center sm:w-96 sm:m-auto mx-5 mb-5 space-y-8">
      ...
      <form action="#">
        <div class="flex flex-col bg-white p-10 rounded-lg shadow space-y-6">
          <h1 class="font-bold text-xl text-center">SIGN UP FOR AN ACCOUNT</h1>
          ...
          <div class="flex flex-col space-y-1">
            <input type="text" name="Email Address" id="Email Address" class="border-2 rounded px-3 py-2 w-full focus:outline-none focus:border-blue-400 focus:shadow" placeholder="Email Address" />
          </div>
