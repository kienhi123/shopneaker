...
const table = {
    render() {
      ...
      <main class="flex-col bg-indigo-50 w-full ml-4 pr-6">
        ...
        <h2 class="uppercase font-bold text-xl my-5 text-blue-800 px-4">Quản Lí Users</h2>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                ${data1.map((item) => `
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <a href="/pages/table/${item.id}/edit" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                  </td>
                </tr>
                  `).join("")}
